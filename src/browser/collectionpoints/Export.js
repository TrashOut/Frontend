...
import { attributes } from '../../common/collectionpoints/consts';
import { connect } from 'react-redux';
import { exportCollectionPoints } from '../../common/collectionpoints/actions';
...
}), { push, exportCollectionPoints, resetExport })
export default class Export extends Component {
  static propTypes = {
    resetExport: React.PropTypes.func,
    exportCollectionPoints: React.PropTypes.func,
  ...
  render() {
    ...
    return (<ExportComponent
      ...
      onSubmit={exportCollectionPoints}
