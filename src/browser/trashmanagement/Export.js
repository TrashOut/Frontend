...
import { attributes } from '../../common/trashmanagement/consts';
import { connect } from 'react-redux';
import { exportTrashes } from '../../common/trashmanagement/actions';
...
}), { push, exportTrashes, resetExport })
export default class Export extends Component {
  static propTypes = {
    resetExport: React.PropTypes.func,
    exportTrashes: React.PropTypes.func,
